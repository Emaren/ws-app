...
export default function GetStonePage() {
  return (
    <main className="ws-container py-8 md:py-10">
      <section className="ws-article rounded-2xl border border-black/10 dark:border-white/15 bg-black/[0.03] dark:bg-white/[0.04] p-5 md:p-7 space-y-5">
        <header className="space-y-2">
          ...
          <h1 className="text-2xl md:text-4xl font-semibold">$STONE</h1>
          <p className="opacity-80 leading-relaxed">
            $STONE is the reputation and utility side of the Wheat &amp; Stone ecosystem. It is
            designed for durable contribution signals across reviews, local commerce activity, and
            community actions.
          </p>
        </header>
        ...
        <section className="space-y-2">
          ...
          <ul className="list-disc pl-5 space-y-1 leading-relaxed">
            <li>Reader engagement and verified participation rewards.</li>
            <li>Contributor quality signaling and long-term reputation weight.</li>
            <li>Future access controls for premium community actions.</li>
          </ul>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p className="opacity-80 leading-relaxed">
            TokenTap is the partner surface for broader token tooling and business automation.
          </p>
