...
.wysiwyg p:empty,
.wysiwyg p:has(> br:only-child){ margin-block:.08rem; min-height:.08rem; }
...
/* Lists */
.wysiwyg :is(ul,ol){ margin:0 0 1rem 1.5rem; padding-left:1.5rem; }
.wysiwyg li{ margin:.25rem 0; }
.wysiwyg li > p{ margin:0; }
.wysiwyg li > :is(ul,ol){ margin-top:.45rem; margin-bottom:.45rem; }
.wysiwyg :is(ul,ol) :is(ul,ol){ margin-left:1.25rem; padding-left:1.25rem; }
...
.wysiwyg blockquote p + p{ margin-top:0; }
